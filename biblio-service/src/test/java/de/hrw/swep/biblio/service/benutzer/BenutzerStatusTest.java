...
import de.hrw.swep.biblio.service.*;
...
public class BenutzerStatusTest {
	...
	/**
	 * Ein Benutzer wird gemahnt: Statusuebergang "Normal" => "Gesperrt" wird
	 * getestet
	 */
	@Test
	...
	/**
	 * Ein gesperrter Nutzer wird freigeschalten: Statusuebergang "Gesperrt" =>
	 * "Normal" wird getestet
	 */
	@Test
